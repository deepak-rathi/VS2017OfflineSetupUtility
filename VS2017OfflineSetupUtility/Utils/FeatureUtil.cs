...
namespace VS2017OfflineSetupUtility.Utils
{
    internal static class FeatureUtil
    {
        ...
        internal static List<Feature> GetFeatures()
        {
            ...
            var cleanUtilFeature = new Feature() { Icon =  cleanUtilIcon, Name = "VS2017 Offline Clean Util", About= "Allow deletion of old version Visual Studio 2017 Offline Setup files and folder, which saves your hard disk space.", Version="1.0.0.0"};
            ...
            var downloadUtilFeature = new Feature() { Icon = downloadUtilIcon, Name = "VS2017 Offline Download", About = "Download Visual Studio 2017 Offline Setup files and folder, using command line interface. (Need internet connection)", Version = "1.0.0.0" , IsEnabled = false};
